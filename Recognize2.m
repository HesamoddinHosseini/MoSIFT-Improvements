...
for k = 1:WantedFrames
   ...
   imwrite(mov(k).cdata,['C:\Users\M A\Desktop\MoSift\Human-Action-Recognition-master\Frames\',num2str(k),'.jpg']);%%%ADDRESS EDITED
end
for I = 1:WantedFrames
   im=imread(['C:\Users\M A\Desktop\MoSift\Human-Action-Recognition-master\Frames\',num2str(I),'.jpg']); %%%ADDRESS EDITED
    figure(1),subplot(5,10,I),imshow(im);
end
clc
for i=1:WantedFrames
    disp(['Processing frame no.',num2str(i)]);
  img=imread(['C:\Users\M A\Desktop\MoSift\Human-Action-Recognition-master\Frames\',num2str(i),'.jpg']);%%%ADDRESS EDITED
